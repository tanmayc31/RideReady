...
def _wl(section, page, symbol, color, meaning, action, severity):
    """Build one curated warning-light chunk."""
    text = (f"Warning light: {section}. "
            f"Symbol: {symbol} Color: {color}. "
            f"Meaning: {meaning} "
            f"Action: {action} "
            f"Severity: {severity}")
    return {**CAMRY, "section": section, "page": page, "text": text}

CURATED_CHUNKS = [
    _wl("Brake System Warning Light", 528,
    ...
    _wl("Tire Pressure Warning Light (TPMS)", 532,
        ...
        "Caution"),
    _wl("Malfunction Indicator Lamp (Check Engine)", 529,
        ...
        "Caution"),
    _wl("SRS Airbag Warning Light", 529,
    ...
    _wl("ABS Warning Light", 529,
        ...
        "Caution"),
    _wl("Electric Power Steering (EPS) Warning Light", 530,
        ...
        "Have the vehicle inspected by your Toyota dealer immediately.",
        "Caution"),
    _wl("Pre-Collision System (PCS) Warning Light", 530,
        ...
        "Caution"),
    _wl("Slip Indicator (VSC/TRAC)", 531,
        ...
        "Caution"),
    _wl("Low Fuel Level Warning Light", 531,
        "an amber/yellow fuel-pump symbol",
        "amber/yellow",
        "The remaining fuel level is low.",
        "Refuel as soon as possible.",
        "Safe to drive"),
    _wl("High Coolant Temperature Warning Light", 528,
        ...
        "Stop safely & check now"),
    _wl("Charging System Warning Light", 528,
        ...
        "Stop safely & check now"),
    _wl("Low Engine Oil Pressure Warning Light", 528,
        "a red oil-can symbol with a drip",
        "red",
        "The engine oil pressure is too low.",
        "Immediately stop the vehicle in a safe place and contact your Toyota dealer.",
        "Stop safely & check now"),
    _wl("Master Warning Light", 538,
...
def parse_page(txt, pdf_index):
    ...
    Manual pages start like '312 4-5. Using the driving support systems ...'.
    Falls back to (pdf_index + 1, 'General') when the pattern isn't present.
    """
    flat = txt.replace("\n", " ")
